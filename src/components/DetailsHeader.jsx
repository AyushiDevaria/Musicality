...
const DetailsHeader = ({ artistId, artistData, songData }) => {
  ...
  return(
    <div className="relative w-full flex flex-col">
      <div className="w-full bg-gradient-to-1 from-transparent to-blank sm:h-48 h-28"/>
      <div className="absolute inset-0 flex items-center">
        ...
        <div className="m1-5">
          <p className="font-bold sm:text-3x1 text-x1 text-white">{artistId ? artist?.name : songData?.title}</p>
          {!artistId && (
